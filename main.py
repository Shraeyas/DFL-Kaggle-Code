if __name__ == "__main__":
    ...
    def process_sort(arguments):
        ...
        Sorter.main (input_path=Path(arguments.input_dir), sort_by_method=arguments.sort_by_method, force_gpu_idxs=arguments.force_gpu_idxs)
    ...
    p.add_argument('--factor', required=True, type=int, dest="factor", default=None, help="Denoise factor (1-20).")
